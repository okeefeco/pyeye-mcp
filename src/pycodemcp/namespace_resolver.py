...
class NamespaceResolver:
    ...
    def register_namespace(self, namespace: str, paths: List[str]):
    ...
    def _detect_namespace_package(self, init_file: Path) -> Optional[str]:
    ...
    def _extract_namespace_from_init(self, init_file: Path) -> Optional[str]:
